    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        ...
        <input
          ...
          className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-base sm:text-lg focus:border-[#0b2540] focus:ring-2 focus:ring-blue-100 outline-none transition-all"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className={`w-full py-3 rounded-lg text-white font-semibold text-base sm:text-lg transition-all duration-200 ${
            loading
              ? "bg-gray-400 cursor-not-allowed shadow-md"
              : "bg-[#0b2540] hover:brightness-95 shadow-md hover:shadow-lg active:shadow-sm"
          }`}
      >
